function initCanvas(){
    ...
    var enemies = [
                   ...
                   new enemyTemplate({id: "enemy21", x: 120, y: -320, w: 40, h: 20 }),
                   new enemyTemplate({id: "enemy22", x: 235, y: -320, w: 40, h: 20 }),
                   new enemyTemplate({id: "enemy23", x: 360, y: -320, w: 70, h: 20 }),
                   new enemyTemplate({id: "enemy24", x:120,  y:-370,  w:70,  h: 20}),
                   new enemyTemplate({id: "enemy25", x:235,  y:-370,  w:40,  h: 30}),
                   new enemyTemplate({id: "enemy26", x:360,  y:-370,  w:40,  h: 30}),
                   new enemyTemplate({id: "enemy27", x:470,  y:-370,  w:40,  h: 30}),
                   new enemyTemplate({id: "enemy28", x:610,  y:-370,  w:70,  h: 30}),
                   new enemyTemplate({id: "enemy29", x:470,  y:-320,  w:40,  h: 30}),
                   new enemyTemplate({id: "enemy30",x: 610, y: -320, w: 40, h: 30}),
                
                   
                   new enemyTemplate({ id: "enemy11", x: 110, y: -420, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy12", x: 235, y: -420, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy13", x: 360, y: -420, w: 70, h: 40, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy14", x: 120, y: -470, w: 70, h: 40, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy15", x: 235, y: -470, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy16", x: 360, y: -470, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy17", x: 485, y: -470, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy18", x: 610, y: -470, w: 70, h: 40, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy19", x: 485, y: -400, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy20", x: 610, y: -400, w: 50, h: 30, image: enemiespic2 }),
                  ];
    ...
    function Launcher(){
        ...
        this.render = function () {
            ...
            if (enemies.length === 0) {
                ...
                ctx.fillText('GANASTE', cW * .5 - 50, 60);
            }
        }
        ...
        this.hitDetectLowerLevel = function(enemy){
            ...
            if(enemy.y > 550){
                ...
                this.gameStatus.message = 'Enemigos han pasado!';
            }
            ...
            if(this.gameStatus.over === true){  
                ...
                ctx.fillText(this.gameStatus.message, cW * .5 - 50, 60); // text x , y
            }
        }
    }
